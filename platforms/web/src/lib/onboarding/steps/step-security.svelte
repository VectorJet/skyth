...
<div class="space-y-6">
	<div class="rounded-md border p-4 bg-amber-50 dark:bg-amber-950/30 border-amber-200 dark:border-amber-900">
	...
	<div class="space-y-4">
		...
		{:else}
			<div class="p-3 text-sm text-green-700 bg-green-100 rounded-md dark:bg-green-900/30 dark:text-green-400">
