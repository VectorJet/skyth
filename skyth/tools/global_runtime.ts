...
export { BashCompatTool, GrepCompatTool, GlobCompatTool };

import {
	WebSearchCompatTool,
	WebFetchCompatTool,
} from "./global_runtime/web_tools";
export { WebSearchCompatTool, WebFetchCompatTool };
...
export { TodoWriteTool, TodoReadTool, TaskCompatTool };
