...
export default defineTool({
  name: "session_read",
  description: "Read full context from another session without merging. Useful to check what happened on another channel.",
  parameters: {
    type: "object",
    properties: {
      session: { type: "string", description: "Session key to read (e.g., 'discord:12345')" },
      limit: { type: "number", description: "Maximum number of recent messages to show" },
    },
    required: ["session"],
  },
