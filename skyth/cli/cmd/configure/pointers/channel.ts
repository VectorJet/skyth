...
const CHANNEL_FIELD_LABELS: Record<string, Record<string, string>> = {
  ...
  discord: { token: "Bot token", public_key: "Public key", application_id: "Application ID", gateway_url: "Gateway URL" },
  whatsapp: { bridge_url: "Bridge URL", bridge_token: "Bridge token" },
  slack: { bot_token: "Bot token (xoxb-...)", signing_secret: "Signing secret", app_token: "App token (xapp-...)" },
