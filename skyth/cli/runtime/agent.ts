...
import { makeProviderFromConfig, strFlag, type ParsedArgs } from "@/cli/runtime_helpers";

export async function agentCommandHandler(parsed: ParsedArgs): Promise<number> {
  const { flags } = parsed;
