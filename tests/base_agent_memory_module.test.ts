...
import { buildMentalImageObservation, recordMentalImage } from "../skyth/base/base_agent/memory/mental_image";
    ...
    recordMentalImage(
      {
        updateMentalImage: (obs) => {
          seen.push({ senderId: obs.senderId, channel: obs.channel, content: obs.content });
        },
      },
      {
        channel: "cli",
