...
import { formatBraveResults, formatSerpApiResults, formatSerperResults, pickConfiguredProviderIds } from "../skyth/tools/websearch/provider_helpers";
...
describe("websearch provider helpers", () => {
  ...
  test("formats serpapi and brave results consistently", () => {
    expect(formatSerpApiResults([{ title: "Two", link: "https://b", snippet: "B" }], 10)).toContain("https://b");
    expect(formatBraveResults([{ title: "Three", url: "https://c", description: "C" }], 10)).toContain("https://c");
  });
